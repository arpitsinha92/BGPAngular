...
/* harmony import */ var _shared_services_app_confirm_app_confirm_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../shared/services/app-confirm/app-confirm.service */ "./src/app/shared/services/app-confirm/app-confirm.service.ts");
...
var MapComponent = /** @class */ (function () {
    function MapComponent(httpClient, confirmService) {
        this.httpClient = httpClient;
        this.confirmService = confirmService;
        this.ApiUrl = 'http://ec2-13-232-104-8.ap-south-1.compute.amazonaws.com:8090/';
        this.url = this.ApiUrl + 'Order';
    }
    MapComponent.prototype.ngOnInit = function () {
        this.getAllOrder();
    };
    MapComponent.prototype.getAllOrder = function () {
        var _this = this;
    ...
    MapComponent.prototype.updatePayment = function (row) {
        var _this = this;
        this.id = row._id;
        this.data = this.httpClient.put(this.url + "/" + this.id, null);
        this.data.subscribe(function (data) {
            _this.msg = data.message;
            if (_this.msg == 'Order Updated') {
                alert(_this.msg);
                _this.getAllOrder();
            }
            else {
    ...
    MapComponent.prototype.orderDetails = function (row) {
        var _this = this;
        this.id = row._id;
        this.data = this.httpClient.get(this.url + "/" + this.id);
        this.data.subscribe(function (data) {
            _this.customersOrderList = data.orders;
        });
    };
    MapComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"], _shared_services_app_confirm_app_confirm_service__WEBPACK_IMPORTED_MODULE_2__["AppConfirmService"]])
    ], MapComponent);
    return MapComponent;
}());
...
/* harmony import */ var _map_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./map.component */ "./src/app/views/map/map.component.ts");
/* harmony import */ var _map_routing__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./map.routing */ "./src/app/views/map/map.routing.ts");
    ...
    AppMapModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                ...
                _angular_flex_layout__WEBPACK_IMPORTED_MODULE_5__["FlexLayoutModule"],
                _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatInputModule"],
                _agm_core__WEBPACK_IMPORTED_MODULE_6__["AgmCoreModule"].forRoot({ apiKey: 'AIzaSyBNcjxo_35qnEG17dQvvftWa68eZWepYE0' }),
                _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(_map_routing__WEBPACK_IMPORTED_MODULE_9__["MapRoutes"])
            ],
            declarations: [_map_component__WEBPACK_IMPORTED_MODULE_8__["MapComponent"]]
        })
    ], AppMapModule);
    return AppMapModule;
}());
